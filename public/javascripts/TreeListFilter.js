 ...
 * 
 * Copyright (c) 2014, AIWSolutions License: GPL2 Project Website:
 * http://wiki.aiwsolutions.net/dOQKO
 */
            ...
            if (liObject.is('li')) {
                ...
                if (liObject.children().length > 0) {
                    for (var j = 0; j < liObject.children().length; j++) {
                        var subDisplay = filterList(
                                jQuery(liObject.children()[j]), filterValue);
