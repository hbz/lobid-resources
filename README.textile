...
Deploy (i.e. "copy") the @context.json@ to staging server:
_scp ./src/main/resources/context.json   lobid@emphytos:/usr/local/lobid/src/lobid.org/download/context-staging.json_

To deploy to production, copy the @context.json@ to the repository with the web-application.
