...
public class IndexIntegrationTest extends LocalIndexSetup {
	...
	public static Collection<Object[]> data() {
		...
		return queries(new Object[][] {
			...
			{ "bibliographicLevel.label.raw:\"Monographic component part\"", /*->*/ 19 },
			{ "subject.componentList.label:Düsseldorf", /*->*/ 2 },
			{ "subject.componentList.label:Duesseldorf", /*->*/ 2 },
			{ "subject.componentList.label:Dusseldorf", /*->*/ 2 },
			{ "subject.componentList.label:Düsseldorfer", /*->*/ 2 },
			...
			{ "inCollection.id:\"http\\://lobid.org/organisations/DE-655#\\!\"", /*->*/ 218 },
			{ "inCollection.id:\"https\\://nrw.digibib.net/search/hbzvk/\"", /*->*/ 247 },
			...
			{ "manufacture.manufacturedBy:\"Benediktinerabtei St. Liudger\"", /*->*/ 1 },
			{ "manufacture.manufacturedBy:Boxberger", /*->*/ 1 },
			{ "manufacture.location:Tübingen", /*->*/ 1 },
			{ "manufacture.location:Tubingen", /*->*/ 1 },
			{ "manufacture.startDate:1934", /*->*/ 1 },
			...
			{ "q.subject:Düsseldorf", /*->*/ 2 },
			{ "q.subject:Duesseldorf", /*->*/ 2 },
			{ "q.subject:Dusseldorf", /*->*/ 2 },
			{ "q.subject:Düsseldorfer", /*->*/ 2 },
			...
			{ "q.all:(Lexicography \\: Selected Papers)", /*->*/ 2 },
