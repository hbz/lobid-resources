...
public class IndexIntegrationTest extends LocalIndexSetup {
	...
	public static Collection<Object[]> data() {
		...
		return queries(new Object[][] {
			...
			{ "inCollection.id:\"http\\://lobid.org/organisations/DE-655#\\!\"", /*->*/ 186 },
			{ "inCollection.id:\"https\\://nrw.digibib.net/search/hbzvk/\"", /*->*/ 208 },
			...
			{ "describedBy.resultOf.object.sourceOrganization.id:\"http\\://lobid.org/organisations/DE-5#\\!\"", /*->*/ 7},
			...
			{ "q.all:\"https\\://d-nb.info/gnd/4042570-8\"", /*->*/ 3 },
			...
			{ "contribution.agent.label.digibib:Westfälisch", /*->*/ 4 },
			...
			{ "accessRights.id:\"http://purl.org/coar/access_right/c_abf2\"", /*->*/ 7 }
		});
	} // @formatter:on
