...
curl -L "http://lobid.org/resources/search?q=%28describedBy.resultOf.object.dateModified%3A%3E2020-06-15+OR+describedBy.resultOf.object.dateCreated%3A%3E2020-06-15%29+AND+contribution.agent.id%3A*&format=bulk"  > $RESOURCES_DIRECTORY/resources-from-20200615.jsonl
